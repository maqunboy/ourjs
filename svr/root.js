 ...
 * 前端路由
 */
app.get('/root/news', function(req, res) {

  var user = req.session.get('user') || {},
    id = req.params.id

  res.render('news.tmpl')

})


app.get('/root/about', function(req, res) {

  var user = req.session.get('user') || {},
    id = req.params.id

  res.render('about.tmpl')
